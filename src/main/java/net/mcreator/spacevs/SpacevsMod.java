...
@Mod("spacevs")
public class SpacevsMod {
	public static final Logger LOGGER = LogManager.getLogger(SpacevsMod.class);
	public static final String MODID = "spacevs";
